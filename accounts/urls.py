...
urlpatterns = [
    ...
    path("org-admins/", OrgAdminFilterView.as_view(), name="org_admin_list"),
    path("org-admin/add/", org_admin_add_view, name="add_org_admin"),
    path("org-admins/<int:pk>/edit/", edit_org_admin, name="org_admin_edit"),
    path("org-admins/<int:pk>/delete/", delete_org_admin, name="org_admin_delete"),
